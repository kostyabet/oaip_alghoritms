...
Procedure ReplaceLastRowElementsWithTheSumOfPreviousRowElements();
Var
    I, J, Sum: Integer;
...
//Задача 18.(?).
//Дано натуральное число N. вывести это число тройками через пробелы,
//начиная с конца. Например: 1234567 ->1 234 567.
Procedure ConclusionInThrees();
Var
    N, I: Integer;
    Str: String;
Begin
